...
if (userLogin) {
  ...
  if (namaUser) {
    namaUser.textContent = userLogin.nama;
  }

  if (fotoUser) {
    fotoUser.src = userLogin.image;
  }
...
function bookSlider() {
  ...
  const container =
    document.getElementById("bookSlider");


  if (!container) {

    console.log(
      "bookSlider tidak ditemukan"
    );
        ...
        >
          ...
          >
            ...
            >
              ...
              <h3
                class="text-[13px] font-bold line-clamp-2"
              >
                ${item.Judul}
              </h3>
              ...
              <p
                class="text-[8px] mt-3 leading-relaxed line-clamp-2"
              >
                ${
                  item.Deskripsi ||
                  "Tidak ada deskripsi."
